...
SELECT * FROM countrylanguage WHERE code ='VAT';
...
-- Clue #4: We're booking the first flight out – maybe we've actually got a chance to catch her this time.
 ...
 --  be flying to.
SELECT * FROM city WHERE countrycode = 'SMR' AND name != district;
...
-- BONUS Clue #7: She knows we're on to her – her taxi dropped her off at the international airport, and she beat us to
...
-- She's in Santa Monica, California United States!
