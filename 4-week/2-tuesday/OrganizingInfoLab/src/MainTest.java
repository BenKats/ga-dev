...
public class MainTest {
    ...
    public void testSumOfTwoLargest(){
        ...
        Assert.assertEquals(14,Main.sumOfTwoLargest(new int[]{5,4, 9}));
    ...
    public void mergeSortedArrays(){
        Assert.assertArrayEquals(new Integer []{1,2,3,4,5,6},Main.mergeSortedArrays(new Integer[]{1,2,3}, new Integer[]{4,5,6}));
        Assert.assertArrayEquals(new Integer []{1,2,3,4,4,5,6},Main.mergeSortedArrays(new Integer[]{1,2,3,4}, new Integer[]{4,5,6}));
        Assert.assertArrayEquals(new Integer []{1,2,3,3,4,5,6},Main.mergeSortedArrays(new Integer[]{1,2,3}, new Integer[]{3,4,5,6}));
        Assert.assertArrayEquals(new Integer []{3,4,5,6},Main.mergeSortedArrays(new Integer[]{}, new Integer[]{3,4,5,6}));
    }
}